...
class RandomAgent:
    ...
    def _update(self, wait: bool = False):
        self.num_updates += 1
...
def make_discrete_env(
    ...
    **kwargs
    ...
    return FakeEnvironment(action_spec=action_spec, observation_spec=observation_spec)
...
def fake_atari_wrapped(
    episode_length: int = 10, oar_wrapper: bool = False
) -> Environment:
    ...
    env = make_discrete_env(
        num_actions=18, num_observations=2, obs_shape=(84, 84, 4), obs_dtype=np.float32
    )
