...
class FrozenLearner(rlba.Learner):
    """Wraps a learner ignoring the step calls, i.e. freezing it."""

    def __init__(
        self, learner: rlba.Learner, step_fn: Optional[Callable[[], None]] = None
    ):
    ...
    def get_variables(self, names: Sequence[str]) -> List[rlba.types.NestedArray]:
        """See base class."""
