...
class CountingTest(absltest.TestCase):
    ...
    def test_counter_caching(self):
        ...
        counter = counting.Counter(parent, time_delta=0.0)
    ...
    def test_return_only_prefixed(self):
        ...
        child1 = counting.Counter(
            parent, "child1", time_delta=0.0, return_only_prefixed=False
        )
        child2 = counting.Counter(
            parent, "child2", time_delta=0.0, return_only_prefixed=True
        )
        child1.increment(foo=1)
    ...
    def test_parent_prefix(self):
        ...
        child = counting.Counter(parent, prefix="child", time_delta=0.0)
